	...
	<main>
		<form action="iniciarSesion.php" method="POST" class="formulario" id="formulario">
			...
			<div class="formulario__grupo formulario__grupo-btn-enviar">
				<button type="submit" class="formulario__btn" name="login">Iniciar sesion</button>
			</div>


			<div>
				<p class="formulario__necesitas">¿Necesitas una cuenta?<a class="formulario__nuevo" href="registro.php"> Registrarse</a></p>
				<p class="formulario__volver">¿Quieres entrar como invitado? <a href="index.php" class="formulario__inicio">Volver al inicio</a></p>
			</div>
		</form>
	</main>
